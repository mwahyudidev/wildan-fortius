...
const CardLineChartWidget = ({title, amount, grow, growAmount, data}: Props) => {
  ...
  return (
    <div className="p-3 border border-gray-200 shadow-lg rounded-lg flex gap-2 items-center">
...
export default CardLineChartWidget